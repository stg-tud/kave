...
namespace KaVE.VsFeedbackGenerator.Utils
{
    ...
    {
        ScheduledAction RegisterCallback(Action callback, int delayInMillisecond);
        ScheduledAction RegisterCallback(Action callback, DateTime timeForCallbackInvocation, Action finishedAction);
    }
