...
{
    [ShellComponent]
    public class TestClassCalculator : IntegerStagedAchievementCalculator
    {
        ...
        public TestClassCalculator(IAchievementListing achievementListing,
        ...
        protected override bool Calculate(IStatistic statistic)
        {
            ...
            StagedCalculation(solutionStatistic.TestClassesCreated);
            return true;
        }
    }
}