...
{
    [ShellComponent]
    public class CleanUpCodeCalculator : IntegerStagedAchievementCalculator
    {
        ...
        public CleanUpCodeCalculator(IAchievementListing achievementListing,
        ...
        protected override bool Calculate(IStatistic statistic)
        {
            ...
            if (!commandStatistic.CommandTypeValues.ContainsKey("CleanupCode"))
            {
                return false;
            }

            StagedCalculation(commandStatistic.CommandTypeValues["CleanupCode"]);
            return true;
        }
    }
}