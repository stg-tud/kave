...
{
    [ShellComponent]
    public class FailedCompileCalculator : IntegerStagedAchievementCalculator
    {
        ...
        public FailedCompileCalculator(IAchievementListing achievementListing,
        ...
        protected override bool Calculate(IStatistic statistic)
        {
            ...
            StagedCalculation(buildStatistic.FailedBuilds);
            return true;
        }
    }
}