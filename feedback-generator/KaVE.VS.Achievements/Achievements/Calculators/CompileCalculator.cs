...
{
    [ShellComponent]
    public class CompileCalculator : IntegerStagedAchievementCalculator
    {
        ...
        public CompileCalculator(IAchievementListing achievementListing,
        ...
        protected override bool Calculate(IStatistic statistic)
        {
            ...
            StagedCalculation(buildStatistic.SuccessfulBuilds);
            return true;
        }
    }
}