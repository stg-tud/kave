...
namespace KaVE.VS.Achievements.UI.AchievementGUI
{
    [ToolWindowDescriptor(
        ProductNeutralId = "AchievementWindow",
        Text = "Achievements",
    ...
    public class AchievementWindowDescriptor : ToolWindowDescriptor
    {
        public AchievementWindowDescriptor(IApplicationHost applicationHost)
