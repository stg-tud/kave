...
{
    internal class UpdateEventProcessorTest : BaseActivityProcessorTest
    {
        public override BaseActivityProcessor Sut
        {
            get { return new UpdateEventActivityProcessor(); }
        }

        [Test]
        public void ShouldAlwaysDropBuildEvents()
        {
            var @event = new UpdateEvent
            {
                OldPluginVersion = "some num",
                NewPluginVersion = "some other num"
            };
