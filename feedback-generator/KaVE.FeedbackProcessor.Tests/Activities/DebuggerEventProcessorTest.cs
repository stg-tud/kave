...
{
    internal class DebuggerEventProcessorTest : BaseActivityProcessorTest
    {
        public override BaseActivityProcessor Sut
        {
            get { return new DebuggerEventActivityProcessor(); }
        }

        [Test]
        public void ShouldAlwaysResultInADebuggingActivity()
        {
