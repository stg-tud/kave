...
namespace KaVE.VS.Achievements.Tests.Achievements.Listing
{
    [TestFixture]
    internal class AchievementListingTest
    {
        ...
        public void DeserializingCompletedAchievementsShouldntRaiseEvent()
        {
            ...
            BaseAchievement.CompletedEventHandler +=
                (achievement, args) => Assert.Fail("Completed Event was raised by" + achievement);
