...
{
    public interface IEventStreamExport
    {
        string CreateString(IEnumerable<IIDEEvent> events);
    }

    public class EventStreamExport : IEventStreamExport
    {
        public static void Write(IEnumerable<IIDEEvent> events, string fileName)
        {
            var ese = new EventStreamExport();
            var contents = ese.CreateString(events);
            File.WriteAllText(fileName, contents);
        }

        public string CreateString(IEnumerable<IIDEEvent> events)
        {
