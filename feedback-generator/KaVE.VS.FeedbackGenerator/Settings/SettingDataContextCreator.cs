...
{
    public static class SettingDataContextCreator
    {
        public static DataConstant<SettingResetType> DataConstant = new DataConstant<SettingResetType>("SettingOrFeedbackReset");
