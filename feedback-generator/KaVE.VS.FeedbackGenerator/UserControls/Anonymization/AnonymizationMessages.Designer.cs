...
namespace KaVE.VS.FeedbackGenerator.UserControls.Anonymization {
    ...
    public class AnonymizationMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Remove identifier that originate in the project (Please note: Selecting this options limits the usefulness of your feedback for us).
        /// </summary>
