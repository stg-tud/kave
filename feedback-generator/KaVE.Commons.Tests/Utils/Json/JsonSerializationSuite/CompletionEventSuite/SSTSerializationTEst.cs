...
namespace KaVE.Commons.Tests.Utils.Json.JsonSerializationSuite.CompletionEventSuite
{
    public class SSTSerializationTest
    {
        ...
        [Test]
        public void VerifyFromJson_Legacy_BeforeExtendingCatchBlocksAndReturns()
        {
            var actual = GetExampleJson_Legacy_BeforeExtendingCatchBlocksAndReturns().ParseJsonTo<ISST>();
            var expected = GetLegacyExample();
            Assert.AreEqual(expected, actual);
        }
        ...
        private static string GetExampleJson_Legacy_BeforeExtendingCatchBlocksAndReturns()
        {
            // do not change! keep for checking exception free reading of old formats!
            return
