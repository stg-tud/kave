...
{
    internal class UnaryExpressionTest : SSTBaseTest
    {
        [Test]
        ...
        public void SettingValues()
        {
            ...
            Assert.AreEqual(sut.Operator, UnaryOperator.Complement);
            Assert.AreEqual(sut.Operand, new ConstantValueExpression());
        }
