...
namespace KaVE.Model.Events
{
    ...
    public abstract class IDEEvent
    {
        ...
        {
            get { return TerminatedAt - TriggeredAt; }
        }

        /// <summary>
        /// The window with the focus at the moment the event is fired. If no window has the focus, this property is <code>null</code>.
        /// </summary>
        [DataMember]
        public WindowName ActiveWindow { get; set; }

        /// <summary>
        /// The document with the focus, i.e., the document inside the active window, at the moment the event is fired. If the focus was not in a document, this property is <code>null</code>.
        /// </summary>
        [DataMember]
